...
> [!NOTE]
> Uploaded tables are held in memory for the duration of your session. To persist data, write it to `/data/` using [`write_csv`](../../reference/data-import-export/CSV/writeCsv.md) or another export method.
